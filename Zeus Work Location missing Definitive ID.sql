/* Is Work Location - entities carrying NO Definitive id */

-- The complement of "Zeus Work Location to Definitive ID data quality evaluation.sql".
...
--      Definitive id. Other-source linkage is reported separately below.
    ...
    SELECT e.EntityId
          ,e.Name AS WorkLocationEntityName
          --,e.EntityDescription
          ,ci.WorkLocationInfoName
          ,cia.Address1 AS WorkLocationAddress1
          ,cia.Address2 AS WorkLocationAddress2
          ,cia.Address3 AS WorkLocationAddress3
          ,cia.City AS WorkLocationCity
          ,cia.Zip AS WorkLocationZip
      ...
      JOIN dbo.WorkLocationInfo AS ci ON ci.WorkLocationInfoId = e.EntityId
 LEFT JOIN dbo.WorkLocationInfoAddress AS cia ON cia.WorkLocationInfoId = ci.WorkLocationInfoId
                                       AND cia.IsDefault = 1
